...
function countSyllables (word) {
  var vowels = '(ie|a|e|i|o|u)'
  return word.match(new RegExp(vowels, 'g') || []).length
}
...
function conjPerf (mamma) {
  ...
  // ending in 'ista', and stem is > 2syll
    ...
    stem = mamma.slice(0, -1) // irrezist- interced- etc
...
function objectProns (sf) { // eslint-disable-line no-unused-vars
