...
<h1>Ġabra API v#{version} <small>Updated 2020-03-16</small></h1>
</div>
...
- The total number of results from the database will be given in `query.result_count`. Use this to decide if you need to fetch further pages: `query.page * query.page_size >= query.result_count`
